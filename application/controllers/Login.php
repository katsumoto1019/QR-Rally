...
class Login extends CI_Controller
{
    ...
    public function loginMe()
    {
        ...
        $this->form_validation->set_rules('email', 'メールアドレス', 'required|valid_email|max_length[128]|trim');
        $this->form_validation->set_rules('password', 'パスワード', 'required|max_length[32]');
    ...
    function createPasswordUser()
    {
        ...
        $this->form_validation->set_rules('cpassword', 'パスワード確認', 'trim|required|matches[password]|max_length[20]');
